...
([COLLECTED; 10] =
 ...
 fn def_one_two_x_right_assoc {
     " (def one_two_x_rgt (z) (+ 1 (+ 2 z))) ",
     Expr::Def(
         Proto { name: ident("one_two_x_rgt"), args: vec![ident("z")] },
         vec![add(1.0, add(2.0, "z"))])
 }

 fn def_one_two_x_left_assoc {
     " (def one_two_x_lft (z) (+ (+ 1 2) z)) ",
     Expr::Def(
